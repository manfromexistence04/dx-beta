      ...
      <div className="relative flex w-full flex-col items-end justify-start overflow-hidden bg-black text-left font-dm-sans-desktop-24px-medium text-xl leading-[normal] tracking-[normal] text-shade-white">
          ...
          <div className="absolute left-[296.9px] top-[32px] h-[434.2px] w-[451px] max-w-full">
            <div className="absolute left-[0px] top-[64.3px] flex w-full max-w-full flex-col items-start justify-start gap-[24px]">
              <div className="flex w-[607px] max-w-[135%] shrink-0 flex-col items-start justify-start gap-[12px]">
                ...
                <div className="relative box-border flex w-[302px] flex-row items-center justify-center gap-[12px] border-[1px] border-solid border-shade-white bg-shade-white px-[15px] py-3.5 text-base text-black shadow-[2px_2px_2px_rgba(0,_0,_0,_0.25)_inset]">
              ...
              <div className="flex max-w-full shrink-0 flex-col items-start justify-start gap-[12px] self-stretch">
                ...
                <div className="relative h-[90px] w-[417px] max-w-full text-center text-base">
                  <div className="absolute left-[0px] top-[0px] flex flex-row items-start justify-start gap-[12px]">
                    <div className="box-border flex w-[137px] flex-row items-center justify-center whitespace-nowrap rounded border-[1px] border-solid border-shade-white bg-gray-500 px-[30px] py-3.5 text-lg">
                      <b className="relative inline-block h-4 leading-[16px]">
                        6 month
                      </b>
                    </div>
                    <div className="box-border flex w-[118px] flex-row items-center justify-center whitespace-nowrap rounded border-[1px] border-solid border-shade-white px-[31px] py-3.5">
                      <b className="relative inline-block h-4 leading-[16px]">
                        1 year
                      </b>
                    </div>
                    <div className="box-border flex w-[118px] flex-row items-center justify-center whitespace-nowrap rounded border-[1px] border-solid border-shade-white px-[29px] py-3.5">
                      <b className="relative inline-block h-4 leading-[16px]">
                        3 years
                      </b>
                    </div>
                  </div>
                  <div className="absolute left-[0px] top-[64px] text-left text-xl font-medium leading-[130%] mq450:text-base mq450:leading-[21px]">
                    5% per year
                  </div>
                </div>
              </div>
              <div className="relative box-border h-px self-stretch border-t-[1px] border-solid border-silver" />
        ...
        <section className="flex w-full flex-row items-start justify-center px-[10%] pb-32 lg:px-0">
          <div className="flex w-full flex-col items-center justify-center space-y-5">
            <h1 className="text-bold !m-0 flex w-full items-center justify-center text-center !text-37xl">
              A new way to apply
            </h1>
            <FrameComponent1 />
            <Calculator />
