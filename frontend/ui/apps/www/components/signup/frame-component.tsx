...
const FrameComponent: NextPage = () => {
    ...
    return (
        <div className="text-blueviolet font-headings-desktop-poppins-16px-bold mq750:pl-[52px] mq750:pr-[50px] mq750:box-border mq750:min-w-full mq1225:flex-1 mq450:pt-[55px] mq450:px-5 mq450:pb-[76px] mq450:box-border mq1050:pt-[84px] mq1050:pb-[117px] mq1050:box-border box-border flex w-[622px] min-w-[622px] max-w-full flex-col items-start justify-start gap-[16px] bg-black pb-[180px] pl-[104px] pr-[100px] pt-[129px] text-left text-sm">
            <div className="relative hidden h-[781px] w-[622px] max-w-full bg-black" />
            <div className="text-13xl text-shade-white font-headings-desktop-poppins-16px-regular flex flex-col items-start justify-start gap-[8px] px-0 pb-4 pt-0">
                <h1 className="font-inherit mq750:text-7xl mq750:leading-[26px] mq450:text-lgi mq450:leading-[19px] relative z-[1] m-0 inline-block min-w-[124px] whitespace-nowrap font-bold leading-[100%] text-inherit">
                    Sign Up
                </h1>
            ...
            >
                ...
                <div className="mq450:gap-[28px] flex max-w-full flex-row items-start justify-start gap-[56px] self-stretch text-base text-black">
            ...
            <div className="text-lightsteelblue flex max-w-full flex-row items-start justify-start gap-[7px]">
                <input
                    className="relative z-[1] m-0 h-6 min-h-[24px] w-6 shrink-0 overflow-hidden"
                    type="checkbox"
                />
            ...
            <button className="bg-blueviolet hover:bg-mediumslateblue z-[1] flex cursor-pointer flex-row items-start justify-center self-stretch whitespace-nowrap rounded px-5 py-[17.5px] [border:none]">
                <b className="font-headings-desktop-poppins-16px-bold text-shade-white relative inline-block min-w-[59px] text-center text-base leading-[16px]">
                    Sign Up
                </b>
            </button>
            <div
