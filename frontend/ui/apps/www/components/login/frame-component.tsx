...
const FrameComponent: NextPage = () => {
    ...
    return (
        <div className="text-blueviolet font-headings-desktop-poppins-16px-bold mq750:px-[51px] mq750:box-border mq750:min-w-full mq1225:flex-1 mq450:pt-[97px] mq450:px-5 mq450:pb-[95px] mq450:box-border mq1050:pt-[149px] mq1050:pb-[146px] mq1050:box-border box-border flex w-[622px] min-w-[622px] max-w-full flex-col items-start justify-start gap-[8px] bg-black px-[102px] pb-56 pt-[230px] text-left text-sm">
            <div className="relative hidden h-[781px] w-[622px] max-w-full bg-black" />
            <div className="text-13xl text-shade-white font-headings-desktop-poppins-16px-regular flex flex-col items-start justify-start gap-[8px] px-0 pb-6 pt-0">
            ...
            <div className="font-dm-sans-desktop-14px-regular box-border flex max-w-full flex-row items-start justify-start self-stretch py-0 pl-[1.5px] pr-px">
                ...
                >
                    ...
                    <div className="font-headings-desktop-poppins-16px-bold mq450:gap-[28px] flex max-w-full flex-row items-start justify-start gap-[56px] self-stretch text-base text-gray-200">
            ...
            <div className="box-border flex max-w-full flex-row items-start justify-start self-stretch px-px pb-2 pt-0">
                <button className="bg-blueviolet hover:bg-mediumslateblue z-[1] box-border flex max-w-full flex-1 cursor-pointer flex-row items-start justify-center whitespace-nowrap rounded px-5 py-4 [border:none]">
                    <b className="font-headings-desktop-poppins-16px-bold text-shade-white relative inline-block min-w-[46px] text-center text-base leading-[16px]">
                        Log In
                    </b>
                </button>
            </div>
