...
const Component: NextPage<ComponentType> = ({
  ...
  return (
    <>
      <Link
        href="/colleges-products">

        <div
          className="text-11xl text-shade-white font-headings-desktop-poppins-16px-regular relative box-border flex max-w-full flex-1 flex-col items-start justify-start gap-[24.6px] pb-[24.4px] pl-0 pr-px pt-0 text-left"
          style={component14Style}
        >
          <div className="absolute inset-x-[0px] bottom-[0px] !m-[0] h-[364.7px] w-full rounded [background:linear-gradient(#000,_#000),_#d9d9d9]" />
