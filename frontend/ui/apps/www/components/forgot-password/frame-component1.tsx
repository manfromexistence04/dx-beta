...
const FrameComponent1: NextPage = () => {
  return (
    <div className="relative flex max-w-full shrink-0 flex-row items-start justify-start self-stretch">
      <img
        className="absolute bottom-[-783px] left-[0px] !m-[0] h-[784px] w-[818px] object-cover"
        loading="lazy"
        alt=""
      ...
      <div className="z-[1] box-border flex max-w-full flex-1 flex-row items-start justify-start bg-gray-300 px-0 pb-px pt-0 [backdrop-filter:blur(28px)]">
        <header className="text-blueviolet font-headings-desktop-poppins-16px-regular box-border flex h-[88px] max-w-full flex-1 flex-col items-start justify-start gap-[20px] overflow-hidden px-0 py-5 text-left text-8xl">
          <div className="hidden h-12 w-[158px]" />
          <div className="mq750:px-10 mq750:box-border box-border flex max-w-full flex-row items-start justify-start self-stretch px-20 py-0">
            <div className="flex max-w-full flex-1 flex-row items-start justify-start gap-[24px]">
              ...
              <div className="text-shade-white font-headings-desktop-poppins-16px-bold flex flex-row items-center justify-start gap-[24px] text-base">
                <div className="flex flex-row items-start justify-start gap-[7px] rounded px-0 py-3">
                  ...
                  <img
                    className="relative h-[15.2px] w-[15.2px] shrink-0 overflow-hidden"
                    alt=""
