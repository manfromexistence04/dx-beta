...
const FrameComponent: NextPage = () => {
  ...
  return (
    <div className="text-13xl text-shade-white font-headings-desktop-poppins-16px-bold mq750:pl-[37px] mq750:box-border mq750:min-w-full mq450:pt-[114px] mq450:pb-[116px] mq450:box-border mq1050:pt-[175px] mq1050:pb-[178px] mq1050:box-border mq1225:flex-1 box-border flex w-[622px] min-w-[622px] max-w-full flex-col items-start justify-start gap-[8px] bg-black pb-[274px] pl-[74px] pr-5 pt-[269px] text-left">
      <div className="relative hidden h-[781px] w-[622px] max-w-full bg-black" />
      <h1 className="font-headings-desktop-poppins-16px-regular mq750:text-7xl mq750:leading-[26px] mq450:text-lgi mq450:leading-[19px] relative z-[1] m-0 inline-block w-[474px] max-w-full font-bold leading-[100%] text-inherit">
      ...
      <div className="text-blueviolet flex w-[417px] max-w-full flex-col items-start justify-start gap-[16px] text-xs">
        <div className="flex flex-col items-start justify-start gap-[4px] self-stretch">
          ...
          <a
            className="text-shade-white relative z-[1] whitespace-nowrap text-base [text-decoration:none]"
        ...
        <div className="box-border flex max-w-full flex-row items-start justify-start self-stretch py-0 pl-px pr-0">
          ...
          >
            <b className="font-headings-desktop-poppins-16px-bold text-shade-white relative inline-block min-w-[63px] text-center text-base leading-[16px]">
              Confirm
            </b>
          </button>
        </div>
