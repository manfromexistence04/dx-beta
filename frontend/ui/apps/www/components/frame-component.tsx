...
const FrameComponent: NextPage = () => {
  return (
    <footer className="self-stretch flex flex-row items-start justify-end py-0 pr-px pl-0 box-border max-w-full text-left text-sm text-lightsteelblue-200 font-dm-sans">
      <div className="flex-1 bg-black box-border flex flex-col items-end justify-start pt-0 pb-6 pr-[290px] pl-[78px] relative gap-[25px] max-w-full z-[1] border-t-[1px] border-solid border-neutrals-2 mq750:pl-[39px] mq750:pr-[145px] mq750:box-border mq450:pr-5 mq450:box-border">
        ...
        <div className="self-stretch flex flex-row items-start justify-start gap-[20px] text-xl text-shade-white font-headings-desktop-poppins-16px-regular mq1225:flex-wrap">
          <div className="flex-1 flex flex-col items-start justify-start pt-[41px] px-0 pb-0 box-border min-w-[129px] text-8xl text-blueviolet-200 mq1225:flex-1">
          ...
          <div className="w-[134px] flex flex-col items-start justify-start pt-8 pb-0 pr-5 pl-0 box-border">
            <b className="relative inline-block min-w-[110px] mq450:text-base">
              Calculator
            </b>
          </div>
          <div className="flex-[0.8985] flex flex-col items-start justify-start pt-8 pb-0 pr-5 pl-0 box-border min-w-[128px] mq1225:flex-1">
            <b className="relative mq450:text-base">Career guidance</b>
          </div>
          <div className="w-[114px] flex flex-col items-start justify-start pt-8 pb-0 pr-5 pl-0 box-border">
            <b className="relative inline-block min-w-[90px] mq450:text-base">
              Colleges
            </b>
          </div>
          <div className="flex flex-col items-start justify-start pt-8 pb-0 pr-5 pl-0">
        ...
        <div className="w-[858px] flex flex-row items-start justify-center max-w-full text-right text-base text-gray-100">
