...
const FrameComponent4: NextPage = () => {
  ...
  return (
    <section className="box-border flex h-auto max-w-full flex-row items-start justify-start self-stretch px-[10%] pt-24 text-center font-headings-desktop-poppins-16px-regular text-29xl text-shade-white mq750:box-border mq750:pb-[31px] lg:px-0">
      <div className="items-strt relative box-border flex min-h-[650px] max-w-full flex-1 flex-col items-start justify-start space-y-10 overflow-hidden overflow-x-auto lg:flex-row">
        ...
        <div className="z-[3] flex flex-col items-start justify-between gap-[20px] mq1225:flex-col lg:absolute lg:bottom-16 lg:!ml-[20%] lg:w-3/5 lg:flex-row lg:items-center lg:justify-between">
