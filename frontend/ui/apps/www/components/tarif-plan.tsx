...
const TarifPlan: NextPage<TarifPlanType> = ({
  ...
  return (
    <div className="w-[350px] shrink-0 flex flex-col items-start justify-start gap-[16px] text-left text-13xl text-blueviolet-200 font-headings-desktop-poppins-16px-regular p-3">
      ...
      <div className="self-stretch overflow-hidden flex flex-row items-end justify-start border rounded-md !min-h-[450px]">
