...
const TarifPlan: NextPage<TarifPlanType> = ({
  ...
  return (
    <div className="w-[305px] shrink-0 flex flex-col items-start justify-start gap-[16px] text-left text-13xl text-blueviolet-200 font-headings-desktop-poppins-16px-regular">
      ...
      <div className="self-stretch overflow-hidden flex flex-row items-end justify-start">
        <div className="flex-1 rounded bg-black flex flex-col items-start justify-start pt-[27.7px] pb-[101.3px] pr-5 pl-6 gap-[32px] border-[0px] border-solid border-darkslateblue mq450:gap-[16px]">
          <img
            className="w-[305px] h-[344px] relative rounded hidden"
            alt=""
            src={rectangle12899}
          />
          <div className="flex flex-row items-start justify-start relative">
            ...
            <div className="h-[70px] w-[70px] absolute !m-[0] top-[-27.7px] left-[-11.5px] [filter:blur(140px)] rounded-[50%] bg-blueviolet-200 z-[2]" />
          </div>
