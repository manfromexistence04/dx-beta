...
export const MusicIcon = (props: React.JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>) => (
  <svg
    aria-hidden="true"
    focusable="false"
    height="24"
...
const operations = <div className="border rounded-full p-2">
...
const items = [{
  label: `Notifications`,
  key: 1,
  children: `Content of tab Notifications`,
},
{
  label: `Cookies`,
  key: 2,
  children: <CardsCookieSettings />,
},
{
  label: `Archeive`,
  key: 3,
  children: `Content of tab Archeive`,
},
...
const Notifications: React.FC = () => {
  ...
  return (
    <>
      <Tabs horizontalMargin="0 0 0 0" tabBarExtraContent={operations} items={items} />
      {/* <br />
      <br />
      <br />
