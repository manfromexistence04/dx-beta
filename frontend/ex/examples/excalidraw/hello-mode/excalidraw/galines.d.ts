...
export declare const through: (
  ...
  to: readonly [number, number, number, number, number, number, number, number],
) => readonly [number, number, number, number, number, number, number, number];
export declare const orthogonal: (
  line: readonly [
    number,
    number,
    number,
...
export declare const orthogonalThrough: (
  against: readonly [
    number,
    number,
    number,
...
export declare const parallelThrough: (
  line: readonly [
    number,
    number,
    number,
