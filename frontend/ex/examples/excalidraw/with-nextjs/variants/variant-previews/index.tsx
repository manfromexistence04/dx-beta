...
export function StaggeredFadeIn() {
  const sentence = "Shoccho Sthapona's Admin Panel";
...
export function LetterPullUp() {
  const words = "Shoccho Sthapona's Admin Panel";
...
export function TypingEffect() {
  const text = "Shoccho Sthapona's Admin Panel";
  ...
  return (
    <h1 className="text-center font-display text-lg font-bold tracking-[-0.02em] drop-shadow-sm md:text-3xl md:leading-[5rem]">
      {displayedText ? displayedText : "Shoccho Sthapona's Admin Panel"}
    </h1>
  );
}
...
export function BlurIn() {
  ...
  return (
    <motion.h1
      ...
      className="text-center font-display text-lg font-bold tracking-[-0.02em] drop-shadow-sm md:text-3xl md:leading-[5rem]"
    >
      Shoccho Sthapona's Admin Panel
    </motion.h1>
  );
}

export function SlightFlip() {
  const word = "Shoccho Sthapona's Admin Panel";
  const variants1 = {
