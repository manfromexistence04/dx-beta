              ...
              <CardContent className="grid gap-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">
                    {items.demandForSpecialty || "No Demand Provided."}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-500 dark:text-gray-400">
                  ...
                  <span className="font-medium">
                    {items.averageSalary || "No Average Salary Provided."}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-500 dark:text-gray-400">
                  ...
                  <span className="font-medium">
                    {items.specialtyCode || "No Specialty Code Provided."}
                  </span>
                </div>
              </CardContent>
              <CardFooter className="flex justify-between">
                <Dialog>
                  ...
                  <DialogContent className="w-[55%] min-w-[300px] max-w-[750px]">
                    <div className="!mb-3 flex w-full flex-col gap-2 overflow-hidden rounded-lg border p-3 text-sm">
                      <div className="flex gap-2">
                        <p>RuralQuota1: </p>
                        <span className="font-semibold">
                          {items.ruralQuota1 || "No RuralQuota1 is Provided."}
                        </span>
                      </div>
                      <Separator />
                      ...
                      <div className="flex gap-2">
                        <p>RuralQuota2: </p>
                        <span className="font-semibold">
                          {items.ruralQuota2 || "No RuralQuota2 is Provided."}
                        </span>
                      </div>
                      <Separator />
                      ...
                      <div className="flex gap-2">
                        <p>RuralQuota3: </p>
                        <span className="font-semibold">
                          {items.ruralQuota3 || "No RuralQuota3 is Provided."}
                        </span>
                      </div>
                      <Separator />
                      ...
                      <div className="flex gap-2">
                        <p>OrphanQuota2: </p>
                        <span className="font-semibold">
                          {items.orphanQuota2 || "No OrphanQuota2 is Provided."}
                        </span>
                      </div>
                      <Separator />
                      ...
                      <div className="flex gap-2">
                        <p>OrphanQuota3: </p>
                        <span className="font-semibold">
                          {items.orphanQuota3 || "No OrphanQuota3 is Provided."}
                        </span>
                      </div>
                      <Separator />
                      ...
                      <div className="flex gap-2">
                        <p>Subjects: </p>
                        <span className="font-semibold">
                          {JSON.stringify(items.subjects, null, 2) ||
...
const [inputedDemandForSpecialty, setInputedDemandForSpecialty] = React.useState("high"); */}
                      ...
                      <div className="flex gap-2">
                        <p>OrphanQuota1: </p>
                        <span className="font-semibold">
                          {items.orphanQuota1 || "No OrphanQuota1 is Provided."}
                        </span>
                      </div>
                      <Separator />
                      ...
                      <div className="flex gap-2">
                        <p>Universities: </p>
                        <span className="font-semibold">
                          {JSON.stringify(items.universities, null, 2) ||
                        ...
                        <div className="create-university min-h-screen !min-w-full space-y-3 p-10 pt-3 lg:flex lg:!min-w-[1500px] lg:flex-col">
                              ...
                              <Button
                                ...
                                onClick={async () => {
                                  ...
                                  const Update: any = await updateDoc(
                                    ...
                                    {
                                      ruralQuota1:
                                        inputedRuralQuota1 || items.ruralQuota1,
                                      ruralQuota3:
                                        inputedRuralQuota3 || items.ruralQuota3,
                                      ...
                                      generalCompetition3:
                                        ...
                                        items.generalCompetition3,
                                      specialtyCode:
                                        inputedSpecialtyCode ||
                                        items.specialtyCode,
                                      disabilitiesQuota1:
                                        inputedDisabilitiesQuota1 ||
                                        items.disabilitiesQuota1,
                                      averageSalary:
                                        inputedAverageSalary ||
                                        items.averageSalary,
                                      subjects:
                                        subjectsTag.flatMap(
                                          (item) => item.text
                                      ...
                                      largeFamiliesQuota1:
                                        ...
                                        items.largeFamiliesQuota1,
                                      threshold:
                                        inputedThreshold || items.threshold,
                                      specialtyName:
                                        inputedSpecialtyName ||
                                        items.specialtyName,
                                      disabilitiesQuota3:
                                        inputedDisabilitiesQuota3 ||
                                        items.disabilitiesQuota3,
                                      ruralQuota2:
                                        inputedRuralQuota2 || items.ruralQuota2,
                                      orphanQuota1:
                                        inputedOrphanQuota1 ||
                                        items.orphanQuota1,
                                      universities:
                                        universitiesTag.flatMap(
                                          (item) => item.text
                                        ) || items.universities,
                                      largeFamiliesQuota3:
                          ...
                          {inputedValues && (
                            <div className="!mb-3 flex w-max min-w-full flex-col gap-2 rounded-lg border p-3 text-sm">
                              ...
                              <div className="flex gap-2">
                                <p>Subjects: </p>
                                <span className="font-semibold">
                                  {subjectsTag.flatMap((item) => item.text) ||
                                    "No Subjects is Provided."}
                                </span>
                              </div>
                          ...
                          <div className="hover-glow-border flex h-auto w-full flex-col items-center justify-center space-y-3 rounded-md border p-10">
                            ...
                            <TagInput
                              ...
                              enableAutocomplete
                              restrictTagsToAutocompleteOptions
                              autocompleteOptions={universities.map(
                                (items) => ({
                                  id: items.id,
                                  text:
                            ...
                            <AnimatedButton
                              ...
                              onClick={async () => {
                                ...
                                const Update: any = await updateDoc(updateRef, {
                                  ruralQuota1:
                                    inputedRuralQuota1 || items.ruralQuotai1,
                                  ruralQuota3:
                                    inputedRuralQuota3 || items.ruralQuota3,
                                  level: inputedLevel || items.level,
                                  orphanQuota2:
                                    inputedOrphanQuota2 || items.orphanQuota2,
                                  disabilitiesQuota2:
                                    inputedDisabilitiesQuota2 ||
                                    items.disabilitiesQuota2,
                                  orphanQuota3:
                                    inputedOrphanQuota3 || items.orphanQuota3,
                                  generalCompetition1:
                                    inputedGeneralCompetition1 ||
                                    items.generalCompetition1,
                                  largeFamiliesQuota2:
                                  ...
                                  generalCompetition3:
                                    ...
                                    items.generalCompetition3,
                                  specialtyCode:
                                    inputedSpecialtyCode || items.specialtyCode,
                                  disabilitiesQuota1:
                                    inputedDisabilitiesQuota1 ||
                                    items.disabilitiesQuota1,
                                  averageSalary:
                                    inputedAverageSalary || items.averageSalary,
                                  subjects:
                                    subjectsTag.flatMap((item) => item.text) ||
                                    items.subjects,
                                  largeFamiliesQuota1:
                                  ...
                                  threshold:
                                    inputedThreshold || items.threshold,
                                  specialtyName:
                                    inputedSpecialtyName || items.specialtyName,
                                  disabilitiesQuota3:
                                    inputedDisabilitiesQuota3 ||
                                    items.disabilitiesQuota3,
                                  ruralQuota2:
                                    inputedRuralQuota2 || items.ruralQuota2,
                                  orphanQuota1:
                                    inputedOrphanQuota1 || items.orphanQuota1,
                                  universities:
                                    universitiesTag.flatMap(
                                      (item) => item.text
                                    ) || items.universities,
