...
const Calculator: NextPage = () => {
  ...
  return (
    <div className="relative z-[1] mx-auto mb-24 box-border flex w-[1200px] max-w-[90%] flex-col items-start justify-start gap-[48px] rounded-sm bg-[#804DFE] px-12 pb-[35px] pt-8 text-left font-headings-desktop-poppins-16px-regular text-21xl text-shade-white mq1050:box-border mq1050:px-6 mq750:gap-[24px] mq450:box-border mq450:pb-[23px] mq450:pt-[21px]">
