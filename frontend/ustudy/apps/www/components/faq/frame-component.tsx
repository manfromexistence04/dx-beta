        ...
        <section className="min-h-screen w-full">
            <div className="mq750:box-border mq750:pb-[55px] mq750:pl-[235px] mq750:pt-8 mq450:box-border mq450:pl-5 relative !m-0 box-border flex h-[244px] !w-full max-w-full flex-1 flex-row items-center justify-center gap-[20px] overflow-hidden bg-gray-200 !p-0 pb-[85px] pl-[470px] pr-0 pt-[50px]">
                ...
                <div className="flex w-full flex-col items-center justify-center">
                    ...
                    <span className="text-primary text-sm">Everything you need to know about our product</span>
                </div>
                <img
            ...
            <div className="faq-content mt-10 flex flex-col space-y-5">
                <div className="faq-content-buttons flex items-center justify-center space-x-7">
                    <Button className="!rounded-[2.5px] !p-6" variant="outline">General</Button>
                    <Button className="!rounded-[2.5px] !p-6" variant="outline">Calculator</Button>
                    <Button className="!rounded-[2.5px] !p-6" variant="outline">Career Test</Button>

                    {/* <div className="p-10 border rounded-[5px]">General</div> */}

                </div>
                <Accordion type="single" collapsible className="mx-auto w-[90%] space-y-5 lg:w-[700px]">
                    <AccordionItem value="item-1">
                        <AccordionTrigger>What is uSTAKING Referral Program?</AccordionTrigger>
                        <AccordionContent>
                            uSTAKING has a smart referral system to reward the activity of system participants. A referral
                            reward program is integrated into the uSTAKING Ecosystem. It allows receiving rewards from
                            ten levels deep after the referral partner has staked the amount of tokens.
                        </AccordionContent>
                    </AccordionItem>
                    <AccordionItem value="item-2">
                        <AccordionTrigger>How can I participate in the Referral Program?</AccordionTrigger>
                        <AccordionContent>
                    ...
                    <AccordionItem value="item-3">
                        <AccordionTrigger>Where can I check my bonus balance?</AccordionTrigger>
                        <AccordionContent>
                    ...
                    <AccordionItem value="item-4">
                        <AccordionTrigger>How much can I get through uSTAKING Referral Program?</AccordionTrigger>
                        <AccordionContent>
                            Yes. It&apos;s animated by default, but you can disable it if you
                            prefer.
                        </AccordionContent>
                    ...
                    <AccordionItem value="item-5">
                        <AccordionTrigger>In what type of currency can I be rewarded?</AccordionTrigger>
                        <AccordionContent>
                            Yes. It&apos;s animated by default, but you can disable it if you
                            prefer.
                        </AccordionContent>
                    ...
                    <AccordionItem value="item-7">
                        <AccordionTrigger>Which reward I can get on every level?</AccordionTrigger>
                        <AccordionContent>
                            Yes. It&apos;s animated by default, but you can disable it if you
                            prefer.
                        </AccordionContent>
