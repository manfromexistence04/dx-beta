...
const FrameComponent1: NextPage = () => {
  return (
    <section className="mq750:box-border mq750:pb-[164px] mq750:pt-5 box-border flex h-[623px] max-w-full shrink-0 flex-row items-start justify-between gap-[20px] self-stretch overflow-hidden bg-[url('/frame-985604@3x.png')] bg-cover bg-top bg-no-repeat px-0 pb-[252px] pt-[19px]">
