...
const FrameComponent: NextPage = () => {
  return (
    <section className="text-lightsteelblue font-headings-desktop-poppins-16px-bold box-border flex w-[1245px] max-w-full flex-row items-start justify-center px-5 py-0 text-left text-5xl">
      <div className="flex w-[1061px] max-w-full flex-row items-start justify-start gap-[16.6px]">
        <div className="flex flex-col items-start justify-start px-0 pb-0 pt-1.5">
          <div className="flex flex-col items-start justify-start gap-[54px]">
            ...
            <img
              ...
              loading="lazy"
              alt=""
              src="/group-985566.svg"
            />
            <img
              className="relative size-5"
              loading="lazy"
              alt=""
              src="/group-985567.svg"
            />
            <img
              className="relative size-5"
              loading="lazy"
              alt=""
              src="/group-985568.svg"
            />
            <img
              className="relative size-5"
              loading="lazy"
              alt=""
              src="/group-985569.svg"
            />
          </div>
        </div>
        <div className="flex max-w-[calc(100%_-_37px)] flex-1 flex-row items-start justify-start gap-[22.4px]">
          <div className="flex flex-col items-start justify-start gap-[44.2px] mq750:hidden">
            <a
              className="relative inline-block min-w-[120px] !bg-clip-text font-bold leading-[125%] tracking-wider text-transparent [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] [background:linear-gradient(92.23deg,_),_#fff] [text-decoration:underline] mq450:text-lgi mq450:leading-[24px]"
