...
const GroupComponent: NextPage = () => {
  return (
    <div className="font-headings-desktop-poppins-16px-bold mq1250:flex-wrap mq1250:box-border text-blueviolet-100 mt-16 box-border flex max-w-full flex-row items-start justify-center gap-[18px] self-stretch text-left text-5xl">
