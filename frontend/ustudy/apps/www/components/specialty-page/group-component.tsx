...
const GroupComponent: NextPage = () => {
  return (
    <div className="font-headings-desktop-poppins-16px-bold mq1250:flex-wrap mq1250:pl-[29px] mq1250:box-border box-border flex min-h-[148px] max-w-full flex-row items-start justify-center gap-[18px] self-stretch py-[38px] pl-[59px] pr-5 text-left text-5xl text-blueviolet-100">
