...
const Footer: NextPage = () => {
  return (
    <footer className="font-dm-sans text-lightsteelblue-200 box-border flex max-w-full flex-row items-center justify-center self-stretch border-t py-0 pl-0 pr-px text-left text-sm ">
      <div className="border-neutrals-2 mq750:box-border mq750:pl-[39px] mq750:pr-[145px] mq450:box-border mq450:pr-5 relative z-[1] box-border hidden max-w-full flex-1 flex-col items-end justify-start gap-[25px] border-t-DEFAULT border-solid bg-black px-[10%] pb-6 pt-10 lg:flex lg:pt-0">
      ...
      <div className="mobile-footer flex h-[500px] w-full flex-col items-start justify-start border-t lg:hidden">
        ...
        <div className="grid min-h-[50%] w-full grid-cols-2 place-content-stretch gap-4 border-b px-[10%]">
          <Link
            href="/calculator">
            <span className="flex size-full items-center justify-center text-xs font-medium hover:underline ">Calculator</span>
          </Link>
          <Link
            href="/calculator">
            <span className="flex size-full items-center justify-center text-xs font-medium hover:underline ">About</span>
          </Link>
          <Link
            href="/calculator">
            <span className="flex size-full items-center justify-center text-xs font-medium hover:underline ">FAQ</span>
          </Link>
          <Link
            href="/calculator">
            <span className="flex size-full items-center justify-center text-xs font-medium hover:underline ">Colleges</span>
          </Link>
          <Link
            href="/calculator">
            <span className="flex size-full items-center justify-center text-xs font-medium hover:underline ">Specialty</span>
          </Link>
          <Link
            href="/calculator">
            <span className="flex size-full items-center justify-center text-xs font-medium hover:underline ">Career Guidence</span>
          </Link>
        </div>
        <div className="flex min-h-[35%] w-full flex-col items-center justify-center">
          ...
          <span className="flex w-full items-center justify-center border-t py-2 text-xs">Term & Conditions</span>
        </div>
