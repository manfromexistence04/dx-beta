...
const TarifPlan: NextPage<TarifPlanType> = ({
  ...
  return (
    <div className="flex h-[700px] w-4/5 shrink-0 flex-col items-start justify-start gap-[16px] p-3 text-left font-headings-desktop-poppins-16px-regular text-13xl text-blueviolet-200 lg:w-[450px]">
