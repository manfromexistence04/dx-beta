...
const TarifPlan: NextPage<TarifPlanType> = ({
  ...
  return (
    <div className="font-headings-desktop-poppins-16px-regular text-13xl text-blueviolet-200 flex h-auto w-4/5 shrink-0 flex-col items-start justify-start gap-[16px] p-3 text-left lg:w-[450px]">
      <div className="flex flex-row items-start justify-center self-stretch px-5 py-0">
        <div className="flex flex-row items-start justify-start gap-[8px]">
          <div className="mq750:text-7xl mq750:leading-[38px] mq450:text-lgi mq450:leading-[29px] relative inline-block min-w-[40px] font-semibold leading-[150%]">
            {prop}
          </div>
          <div className="flex flex-col items-start justify-start px-0 pb-0 pt-[23px]">
            <div className="bg-darkblue relative h-0.5 w-10" />
          </div>
        </div>
      </div>
      <div className="flex min-h-[250px] flex-row items-end justify-start self-stretch overflow-hidden rounded-md border border-[#804DFE] lg:min-h-[425px]">
        <div className="border-darkslateblue mq450:gap-[16px] flex flex-1 flex-col items-start justify-start gap-[32px] rounded border-0 border-solid bg-black pb-[101.3px] pl-6 pr-5 pt-[27.7px]">
          ...
          <div className="font-dm-sans text-gainsboro-200 mq450:text-base mq450:leading-[32px] relative z-[1] self-stretch text-xl leading-[40px]">
            {qualityAdmissionsAdviceSh}
          </div>
        </div>
      </div>
