...
import { AccordionTrigger, AccordionContent, AccordionItem, Accordion } from "@/registry/default//ui/accordion"
import { Checkbox } from "@/registry/default//ui/checkbox"
import { Label } from "@/registry/default//ui/label"
import { CardContent, Card } from "@/registry/default//ui/card"
        ...
        <div className="container grid items-center gap-8 px-4 md:px-6 lg:grid-cols-2">
          <div className="space-y-4">
            ...
            <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
              Discover the perfect job opportunity that aligns with your skills and passions. Browse our extensive
          ...
          <div className="grid gap-6 md:gap-8">
            <div className="grid gap-4 md:gap-6">
              <div className="grid gap-1">
                ...
                <p className="text-gray-500 dark:text-gray-400">Browse our curated list of open positions.</p>
              </div>
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                <Card>
                  <CardContent className="space-y-2">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">
                      Lead the development of our cutting-edge web application. Collaborate with a talented team of
                ...
                <Card>
                  <CardContent className="space-y-2">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">
                      Join our design team and help shape the user experience of our innovative products. Bring your
                ...
                <Card>
                  <CardContent className="space-y-2">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">
                      Develop and execute effective digital marketing campaigns to drive growth and engagement for our
                      brand. Leverage data-driven insights.
                    </p>
                    <Button size="sm">Apply Now</Button>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="space-y-2">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">
                      Join our sales team and help businesses discover our innovative solutions. Excellent communication
                ...
                <Card>
                  <CardContent className="space-y-2">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">
                      Analyze financial data and provide insights to help our company make informed decisions. Strong
                ...
                <Card>
                  <CardContent className="space-y-2">
                    ...
                    <p className="text-gray-500 dark:text-gray-400">
                      Craft engaging and informative content to support our marketing initiatives. Excellent writing and
