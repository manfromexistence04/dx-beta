...
export default function Footer() {
  return (
    <footer className="main-footer bg-background text-muted-foreground py-12 md:py-16 border-t">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-2xl font-bold mb-4">Shoccho Sthapona</h3>
        ...
        <div className="mt-8 text-center text-primary">© 2024 Shoccho Sthapona. All rights reserved.</div>
      </div>
    </footer>
  )
}
