        ...
        {docs.map((items) => (
          <div key={items.id}>
            <Card className="hover-glow-border w-full relative hover:bg-primary-foreground h-full flex flex-col">
              ...
              {items.images && items.images.length > 0 ? "" : items.image ? "" : <div className="center rounded-md border flex-1 min-h-[250px]">No image is provided.</div>}

              <div className="absolute bottom-7 left-7">
                <Avatar>
                  <AvatarImage className="max-w-[30px] max-h-[30px]" src={items.logo} alt="@Ustudy" />
                  <AvatarFallback className="!text-xs">UY</AvatarFallback>
                </Avatar>
              </div>
